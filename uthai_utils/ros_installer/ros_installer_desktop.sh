...
echo
echo "====================================================================="
echo "============= Install Robot Operating System on Ubuntu =============="
echo "====================================================================="
...
echo
echo "1. Desktop-Full Install(Recommended)"
...
do
    case $selected in
        1)
            echo "[Installing ROS]"
            sudo apt install -y ros-$name_ros_distro-desktop-full
            break;
            ;;
        2)
            echo "[Installing ROS]"
            sudo apt install -y ros-$name_ros_distro-desktop
            break;
            ;;
        3) 
            echo "[Installing ROS]"
            sudo apt install -y ros-$name_ros_distro-ros-base
            break;
            ;;
        *)
            echo "ONLY 1-3"
